...
/**
 * Created by kucerj28@fjfi.cvut.cz on 10/10/13.
 */
...
public class Histogram {
    ...
    public static void main(String[] args) {
        ...
        Distribution distribution = new NormalDistribution(10,1);
        for (int t = 0; t < T; t++) {
            histogram.addDataPoint((int) distribution.getRealization());
        }
